...
{
    // 只生成第一组
    public static function arr($data, $childrenfield = 'rows', $pidfield = 'pid', $idfield = 'id'){
        return isset(self::tree($data, $childrenfield, $pidfield, $idfield)[0]) ? self::tree($data, $childrenfield, $pidfield, $idfield)[0] : array();
    }
    // 生成树
