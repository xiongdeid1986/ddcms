    ...
    function(s, t, e, n) {
        function a(i, t) {
            this.element = i,
                ...
                this._defaults = o,
                this._name = l;
            var e = this.$el.data(),/*取得元素的全部data*/
                n = {};
            for (var a in e) if (e.hasOwnProperty(a) && a.match(/zs[A-Z]/)) {
                var r = a.substr(2);
        ...
        s.extend(a.prototype, {
            ...
            _promoteChildren: function(i) {
                var index = i ? i : 0,
                    c = this.$el.children('.item');
                $this = s(c).eq(index),
                c.hide(),
                $this.show(),
            ...
            s.fn[l] = function(i) {
                return this.each(function() {
                    s.data(this, "plugin_" + l) || s.data(this, "plugin_" + l, new a(this, i))
                })
            };
        var r = s("[data-zs-src]");
